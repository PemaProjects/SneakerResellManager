<template>
    <div class="h-screen w-full flex justify-center items-center">
        <section class="w-[40%] h-[80%] bg-background2 rounded-l-3xl">
            <div class="flex flex-col justify-center items-center h-full gap-16">
                ...
                <footer class="flex justify-center items-center text-xs gap-1">
                    ...
                    <NuxtLink to="/register"
                        class="text-primary font-bold hover:text-primary/80 transition duration-200">Registrate
                    </NuxtLink>
                </footer>
            </div>
        </section>

        <section class="w-[60%] h-[80%] overflow-hidden rounded-r-3xl">
            <img class="w-full h-full object-cover" src="/public/sneakers-bg.jpg" alt="">
        </section>
